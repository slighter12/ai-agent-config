...
Use when risk classification, validation strategy, verification depth, E2E scope, or coverage confidence for a change is primary.
...
- v0.1.6 (2026-06-30): Add E2E guardrail routing for critical journeys, stable selectors, isolated data, and artifacts.
