...
- `SKILL_EVOLUTION_GATE.md` - Self-contained gate for approved skill evolution and new skill admission
- `CLI_BACKED_SKILLS.md` - Guidance for using deterministic scripts, CLIs, or helpers behind portable skills
- `PLACEMENT_AND_INSTALLATION.md` - Source-of-truth, provider surface, install, and discovery rules
