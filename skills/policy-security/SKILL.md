...
description: "Apply security rules: authn/authz, secrets, privacy, input validation, crypto usage, and threat modeling. Keywords: authn, authz, secrets, privacy, PII, crypto, input validation, XSS, CSRF, logging safety, dependency security. Use when threat exposure or security controls are in scope. Avoid when no security impact."
metadata:
  version: "0.1.2"
---
...
Use when trust boundaries, leak prevention, authn/authz, secret handling, privacy/PII exposure, crypto usage, or sensitive logging/exposure risks are primary.
...
- v0.1.2 (2026-06-30): Add high-level privacy-by-design routing for data minimization and PII exposure.
