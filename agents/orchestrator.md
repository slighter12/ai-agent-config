...
- The main agent has chosen delegated orchestration for a complex task.
- The user explicitly asks for an orchestrator or team lead.

## Do Not Use When

- The user has not requested an orchestrator and direct execution is sufficient.
...
- Keep one lightweight source of truth for assumptions and status.
