...
3. Keep output grounded in the provided scope and existing project conventions.
4. Perform direct edits only when the handoff explicitly allows it and names the permitted files.
